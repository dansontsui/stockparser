...
def parser_major_data_to_csv_data(folder_twday,filename,findBrokName,mainid,subid,sdate,stockid):
...
for daynumber in range(totaldays):
    ...
    for r in range(0,row):#每一家證券公司
        ...
        try:            
            ...
            #df1 = parser_major_data_to_csv_data(folder_twday,filename,findBrokName,mainBrok,subBrok,twday,stockid)
            if df1 is None:
                continue
